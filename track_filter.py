...
CONFIG = {
    "folder_name": "/media/maxine/c8f4bcb2-c1fe-4676-877d-8e476418f5e5/0-RPE-cell-timelapse/track_datasets/healthy/",
    "train_wells": wells_dictionnary['healthy'] + wells_dictionnary['drugged'],
    "test_wells": wells_dictionnary['healthy_test'] + wells_dictionnary['drugged_test'],
